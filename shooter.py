...
class GameSprite(sprite.Sprite):
    ...
    def reset(self):
        window.blit(self.image, (self.rect.x, self.rect.y))  # TODO: add obj
...
class Player(GameSprite):
    ...
    def fire(self):
        ...
        bullets.add(bullet)  # TODO: add seq
...
class Statistics:
    def __init__(self, st_point_win=0, st_point_lose=0, duration=0, level=0):
        ...
        self._duration = st_point_lose
        self._level = level

    def __repr__(self):
        return f'{self._st_point_lose}{self._st_point_win} {self._duration}{self._level}'
...
while run:
    for e in event.get():
        ...
        if not finish:
            ...
            label_missed = font2. render('Missed:'+ str(LOST), 1, LABEL_MISSED_COLOR)
